...
const std::unordered_map<string, SupportedOpType> OP_NAME_TO_SOC_OP_TYPE_MAP{
  ...
  {"Add", SupportedOpType::BIASADD},
  {"BiasAdd", SupportedOpType::BIASADD},
  {"Relu", SupportedOpType::RELU},
  {"MaxPool", SupportedOpType::MAXPOOL},
  {"AvgPool", SupportedOpType::AVGPOOL},
  ...
  {"Identity", SupportedOpType::IDENTITY},
};
